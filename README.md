...
> 这是一款功能非常丰富的小程序，可以方便的帮助程序员朋友刷面试题，准备面试。日常学习各种必备的技能等等。除此之外，这里也是作者[大帅](https://space.bilibili.com/422646817)的各种创意想法的试验场。项目由uni-app(vue2)+uniCloud开发，前端会逐步将有意思的部分开源。

![./mpcode.png](./mpcode.png)
